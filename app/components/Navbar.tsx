...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <nav
        className={`fixed w-full h-16 flex text-base 2xl:text-xl justify-end p-4 bg-neutral-200 z-[100] border-b-2 border-neutral-300`}
      >
        {/* Desktop nav */}
        <div className="fixed top-4 left-6 md:left-10">
          <Link className="focus:border-blue-300 hover:text-blue-300" href="/" >
