  ...
  return (
    ...
    <div className="w-full mx-auto flex flex-col justify-center items-center xs:w-[90vw] md:p-8 lg:pt-20 xl:pt-20 xl:px-20 md:grid lg:grid-cols-2 ">
        {drawings.map((drawing) => (
          <div key={drawing.id} className="relative my-4 flex flex-col h-[250px] w-[250px] xs:w-[350px] xs:h-[400px] md:w-[600px] md:h-[600px] lg:w-[400px] lg:h-[240px] 2xl:w-[600px] 2xl:h-[430px] ">
